from src.generators import filter_by_currency, card_number_generator, transaction_descriptions, transactions
import pytest
...
def test_filter_by_currency(transactions_list, currency):
    """тестирование фильтра валютной операции"""
    assert ((next(filter_by_currency(transactions, currency)))["operationAmount"]["currency"]["code"]) == currency
